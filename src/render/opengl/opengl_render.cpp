// Implements render.h with opengl
...
namespace render
{
	...
	class OpenGLPipeline : public ShaderPipeline
	{
		public:
	...
	ShaderPipeline *OpenGLRenderDevice::CreatePipeline(VertexShader *vertexShader, PixelShader *pixelShader)
	{
	...
	void OpenGLRenderDevice::DestroyShaderPipeline(ShaderPipeline *pipeline)
	{
		delete pipeline;
	}

	void OpenGLRenderDevice::SetPipeline(ShaderPipeline *pipeline)
	{
